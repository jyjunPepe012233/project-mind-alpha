...
public class WorldEnemyPlacerAI : MonoBehaviour
{
    ...
    private Vector3 CalculatePosition(UserInformationSo userInfo)
    {
        ...
        return totalWeight == 0 ? Vector3.zero : weightedPositionSum / totalWeight;
    }
...
//
//            // 예측된 위치 표시
//            Gizmos.color = Color.green; // 예측된 위치는 초록색
//            Gizmos.DrawSphere(predictedPosition, 0.5f); // 예측된 위치에 구 그리기
//
//            Handles.Label(predictedPosition + Vector3.up, $"Predicted Position"); // 예측된 위치 레이블
//        }
//    }
}
