...
public class InventoryMenuView : MonoBehaviour
{
    ...
    [Header("카테고리 슬롯들")]
    [SerializeField] private List<InventorySlotView> magicSlots;
    [SerializeField] private List<InventorySlotView> staffSlots;
    [SerializeField] private List<InventorySlotView> toolSlots;
    [SerializeField] private List<InventorySlotView> protectionSlots;
    ...
    private Dictionary<int, List<InventorySlotView>> slotMap;
    ...
    private void Awake()
    {
        ...
        slotMap = new Dictionary<int, List<InventorySlotView>>()
        {
            { 0, magicSlots },
            { 1, staffSlots },
            { 2, toolSlots },
    ...
    public List<InventorySlotView> GetCurrentSlots(int categoryId)
    {
